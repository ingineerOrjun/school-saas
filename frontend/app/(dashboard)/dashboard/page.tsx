...
export default function DashboardPage() {
  ...
  // Auth guard — if there's no token, bounce to /login.
  React.useEffect(() => {
...
function WelcomeHero({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/50 bg-gradient-to-br from-indigo-500/8 via-purple-500/6 to-transparent p-8 shadow-[0_1px_0_hsl(0_0%_100%/0.5)_inset,0_20px_40px_-20px_hsl(238_60%_50%/0.15)] animate-fade-in-up">
